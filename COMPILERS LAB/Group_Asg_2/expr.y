...
primary_expression:IDENTIFIER                                               {tree_node* arr[] = {create_leaf_node("IDENTIFIER",-1,-1,$1)};$$=create_int_node("primary_expression",arr,1);}
        | FLO_CONSTANT                                                      {tree_node* arr[] = {create_leaf_node("primary_expression",-1,$1,NULL)};$$=create_int_node("primary_expression",arr,1);}
        | INT_CONSTANT                                                      {tree_node* arr[] = {create_leaf_node("primary_expression",$1,-1,NULL)};$$=create_int_node("primary_expression",arr,1);}
        | STRING_LITERAL                                                    {tree_node* arr[] = {create_leaf_node("STRING_LITERAL",-1,-1,$1)};$$=create_int_node("primary_expression",arr,1);}
...
declaration: declaration_specifiers init_declarator_list ';'                {tree_node* arr[] = {$1,$2,create_leaf_node(";",-1,-1,";")};$$=create_int_node("declaration",arr,3);}
        | declaration_specifiers ';'                                       {tree_node* arr[] = {$1,create_leaf_node(";",-1,-1,";")};$$=create_int_node("declaration",arr,2);}
        ;
...
init_declarator_list: init_declarator                                    {tree_node* arr[] = {$1};$$=create_int_node("init_declarator_list",arr,1);}
        | init_declarator_list ',' init_declarator                        {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),$3};$$=create_int_node("init_declarator_list",arr,3);}
        ;

init_declarator: declarator '=' initializer                                {tree_node* arr[] = {$1,create_leaf_node("=",1,-1,"="),$3};$$=create_int_node("init_declarator",arr,3);}
...
parameter_type_list: parameter_list                                        {tree_node* arr[] = {$1};$$=create_int_node("parameter_type_list",arr,1);}
        | parameter_list ',' ELLIPSIS                                      {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),create_leaf_node("ELLIPSIS",-1,-1,"ELLIPSIS")};$$=create_int_node("parameter_type_list",arr,3);}
        ;

parameter_list: parameter_declaration                                      {tree_node* arr[] = {$1};$$=create_int_node("parameter_list",arr,1);}
        | parameter_list ',' parameter_declaration                          {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),$3};$$=create_int_node("parameter_list",arr,3);}
        ;
...
identifier_list: IDENTIFIER                                                {tree_node* arr[] = {create_leaf_node("IDENTIFIER",-1,-1,$1)};$$=create_int_node("identifier_list",arr,1);}
        | identifier_list ',' IDENTIFIER                                    {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),create_leaf_node("IDENTIFIER",-1,-1,$3)};$$=create_int_node("identifier_list",arr,3);}
        ;
...
initializer: assignment_expression                                        {tree_node* arr[] = {$1};$$=create_int_node("initializer",arr,1);}
        ...
        | '{' initializer_list ',' '}'                                     {tree_node* arr[] = {create_leaf_node("{",-1,-1,"{"),$2,create_leaf_node(",",-1,-1,","),create_leaf_node("}",-1,-1,"}")};$$=create_int_node("initializer",arr,4);}
        ;
...
initializer_list: initializer                                              {tree_node* arr[] = {$1};$$=create_int_node("initializer_list",arr,1);}
        ...
        | initializer_list ',' initializer                                  {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),$3};$$=create_int_node("initializer_list",arr,3);}
        | initializer_list ',' designation initializer                      {tree_node* arr[] = {$1,create_leaf_node(",",1,-1,","),$3,$4};$$=create_int_node("initializer_list",arr,4);}
        ;

designation: designator_list '='                                          {tree_node* arr[] = {$1,create_leaf_node("=",1,-1,"=")};$$=create_int_node("designation",arr,2);}
        ;
...
designator: '[' constant_expression ']'                                    {tree_node* arr[] = {create_leaf_node("[",-1,-1,"["),$2,create_leaf_node("]",-1,-1,"]")};$$=create_int_node("designator",arr,3);}
        | '.' IDENTIFIER                                                    {tree_node* arr[] = {create_leaf_node(".",1,-1,"."),create_leaf_node("IDENTIFIER",-1,-1,$2)};$$=create_int_node("designator",arr,2);}
        ;
...
expression_statement: ';'                                                 {tree_node* arr[] = {create_leaf_node(";",-1,-1,";")};$$=create_int_node("expression_statement",arr,1);}
        | expression ';'                                                 {tree_node* arr[] = {$1,create_leaf_node(";",-1,-1,";")};$$=create_int_node("expression_statement",arr,2);}
        ;

selection_statement: IF '(' expression ')' statement                       {tree_node* arr[] = {create_leaf_node("IF",-1,-1,"IF"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(")",-1,-1,")"),$5};$$=create_int_node("selection_statement",arr,5);}
        | IF '(' expression ')' statement ELSE statement                  {tree_node* arr[] = {create_leaf_node("IF",-1,-1,"IF"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(")",-1,-1,")"),$5,create_leaf_node("ELSE",-1,-1,"ELSE"),$7};$$=create_int_node("selection_statement",arr,7);}
...
iteration_statement: WHILE '(' expression ')' statement                    {tree_node* arr[] = {create_leaf_node("WHILE",-1,-1,"WHILE"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(")",-1,-1,")"),$5};$$=create_int_node("iteration_statement",arr,5);}
        | DO statement WHILE '(' expression ')' ';'                       {tree_node* arr[] = {create_leaf_node("DO",-1,-1,"DO"),$2,create_leaf_node("WHILE",-1,-1,"WHILE"),create_leaf_node("(",1,-1,"("),$5,create_leaf_node(")",-1,-1,")"),create_leaf_node(";",-1,-1,";")};$$=create_int_node("iteration_statement",arr,7);}
        | FOR '(' ';' ';' ')' statement                                   {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),create_leaf_node(";",-1,-1,";"),create_leaf_node(";",-1,-1,";"),create_leaf_node(")",-1,-1,")"),$6};$$=create_int_node("iteration_statement",arr,6);}
        | FOR '(' expression ';' ')' statement                            {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(";",-1,-1,";"),create_leaf_node(")",-1,-1,")"),$6};$$=create_int_node("iteration_statement",arr,6);}
        | FOR '(' expression ';' expression ')' statement                 {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(";",-1,-1,";"),$5,create_leaf_node(")",-1,-1,")"),$7};$$=create_int_node("iteration_statement",arr,7);}
        | FOR '(' expression ';' expression ';' expression ')' statement  {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),$3,create_leaf_node(";",-1,-1,";"),$5,create_leaf_node(";",-1,-1,";"),$7,create_leaf_node(")",-1,-1,")"),$9};$$=create_int_node("iteration_statement",arr,9);}
        | FOR '(' ';' expression ';' expression ')' statement             {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),create_leaf_node(";",-1,-1,";"),$4,create_leaf_node(";",-1,-1,";"),$6,create_leaf_node(")",-1,-1,")"),$8};$$=create_int_node("iteration_statement",arr,8);}
        | FOR '(' ';' ';' expression ')' statement                        {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),create_leaf_node(";",-1,-1,";"),create_leaf_node(";",-1,-1,";"),$5,create_leaf_node(")",-1,-1,")"),$7};$$=create_int_node("iteration_statement",arr,7);}
        | FOR '(' declaration expression ';' ')' statement                {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),$3,$4,create_leaf_node(";",-1,-1,";"),create_leaf_node(")",-1,-1,")"),$7};$$=create_int_node("iteration_statement",arr,7);}
        | FOR '(' declaration expression ';' expression ')' statement     {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),$3,$4,create_leaf_node(";",-1,-1,";"),$6,create_leaf_node(")",-1,-1,")"),$8};$$=create_int_node("iteration_statement",arr,8);}
        | FOR '(' ';' expression ')' statement                            {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),create_leaf_node(";",-1,-1,";"),$4,create_leaf_node(")",-1,-1,")"),$6};$$=create_int_node("iteration_statement",arr,6);}
        | FOR '(' ';' ')' statement                                       {tree_node* arr[] = {create_leaf_node("FOR",-1,-1,"FOR"),create_leaf_node("(",1,-1,"("),create_leaf_node(";",-1,-1,";"),create_leaf_node(")",-1,-1,")"),$5};$$=create_int_node("iteration_statement",arr,5);}
        ;

jump_statement: GOTO IDENTIFIER ';'                                       {tree_node* arr[] = {create_leaf_node("GOTO",-1,-1,"GOTO"),create_leaf_node("IDENTIFIER",-1,-1,$2),create_leaf_node(";",-1,-1,";")};$$=create_int_node("jump_statement",arr,3);}
        | CONTINUE ';'                                                   {tree_node* arr[] = {create_leaf_node("CONTINUE",-1,-1,"CONTINUE"),create_leaf_node(";",-1,-1,";")};$$=create_int_node("jump_statement",arr,2);}
        | BREAK ';'                                                      {tree_node* arr[] = {create_leaf_node("BREAK",-1,-1,"BREAK"),create_leaf_node(";",-1,-1,";")};$$=create_int_node("jump_statement",arr,2);}
        | RETURN ';'                                                     {tree_node* arr[] = {create_leaf_node("RETURN",-1,-1,"RETURN"),create_leaf_node(";",-1,-1,";")};$$=create_int_node("jump_statement",arr,2);}
        | RETURN expression ';'                                          {tree_node* arr[] = {create_leaf_node("RETURN",-1,-1,"RETURN"),$2,create_leaf_node(";",-1,-1,";")};$$=create_int_node("jump_statement",arr,3);}
        ;


/* External Definitions */

translation_unit: external_declaration                                      {tree_node* arr[] = {$1};$$=create_int_node("translation_unit",arr,1);}
